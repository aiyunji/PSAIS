...
// Data augmentation ƴͼ
mat_cv* image_data_augmentation_picture_puzzle_4_1(mat_cv* mat1, mat_cv* mat2, mat_cv* mat3, mat_cv* mat4, int w, int h,
    int flip,
...
// Data augmentation ƴͼ
mat_cv* image_data_augmentation_picture_puzzle_2_1(mat_cv* mat1, mat_cv* mat2, int w, int h,
    int flip,
    float dhue, float dsat, float dexp,
    int gaussian_noise, int blur, int num_boxes, int truth_size, float *truth, int *w_new1, int *h_new1, int *w_new2, int *h_new2);
// Data augmentation ƴͼ
mat_cv* image_data_augmentation_picture_puzzle_1_1(mat_cv* mat1, int w, int h,
    int flip,
    float dhue, float dsat, float dexp,
